...
var knownDevices = []knownDevice{
	...
	knownDevice{deviceType: 0x61a2, name: "Broadlink RM4 Pro", supported: true, ir: true, rf: true, power: false, requestHeader: []byte{0x04, 0x00}, codeSendingHeader: []byte{0xd0, 0x00}},
